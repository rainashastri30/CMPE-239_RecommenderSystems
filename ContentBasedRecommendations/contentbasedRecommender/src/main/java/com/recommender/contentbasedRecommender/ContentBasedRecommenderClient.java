...
public class ContentBasedRecommenderClient {

	public static void main(String[] args) {
		ContentBasedRecommender recommender = new ContentBasedRecommender();
		System.out.println("************** WELCOME CONTENT BASED RECOMMENDER*********************");
		...
		if (checkIfUserIsValid(userId)) {
			...
			System.out.println("******************** Movies watched so far ***********************");
			...
			System.out.println("******************** Movie Recommendations for you ***********************");
			// Recommend unseen movies to logged in user using content based recommendation
